        ...
        <div>
            <div className="w-full flex justify-between">
                ...
                <div className="max-w-lg lg:flex space-x-5 items-center hidden">
                    <Link href="/"><p className="text-white text-xl hover:text-red-700">About us</p></Link>
                    <Link href="/"><p className="text-white text-xl hover:text-red-700">Services</p></Link>
                    <Link href="/"><p className="text-white text-xl hover:text-red-700">Strategies</p></Link>
